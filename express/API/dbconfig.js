...
module.exports = {
  user          : process.env.NODE_ORACLEDB_USER || "app_owner",
  ...
  connectString : process.env.NODE_ORACLEDB_CONNECTIONSTRING || "(DESCRIPTION =    (ADDRESS = (PROTOCOL = TCP)(HOST = myserver.mycompany.com)(PORT = 1561))    (CONNECT_DATA =      (SERVER = DEDICATED) (SERVICE_NAME = appdb.mycompany.com) ) )"
,
